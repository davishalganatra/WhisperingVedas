...
async def chat_completions(request: ChatRequest, api_key: str = Security(verify_api_key)):
    try:
        ...
        if "start tapasya" in user_message.lower():
            # Example: "Start tapasya daily_vedic for user123"
            user_id = "user123"
            ...
            # Example: "Log event for user123: mantra Om Namah Shivaya, vibration 7.5, state peaceful"
            user_id = "user123"
            ...
            # Mantra suggestion
            # Expected format: "Suggest a mantra for emotion: <emotion>, goal: <goal>, chakra: <chakra>"
